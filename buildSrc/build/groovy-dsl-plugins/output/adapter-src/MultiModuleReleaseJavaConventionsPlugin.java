...
/**
 * Precompiled multi-module-release.java-conventions script plugin.
 **/
public class MultiModuleReleaseJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_MultiModuleReleaseJavaConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.github.spotbugs");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_MultiModuleReleaseJavaConventions").asSubclass(BasicScript.class);
